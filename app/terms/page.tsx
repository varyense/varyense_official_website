...
export default function TermsPage() {
  return (
    <div className="space-y-10">
      ...
      <WebPageSchema name="Terms & Conditions" description="Read the Varyense Terms & Conditions: basic rules for using our website and exploring our work as the company evolves." path="/terms" />

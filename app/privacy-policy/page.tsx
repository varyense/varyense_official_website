...
export default function PrivacyPolicyPage() {
  return (
    ...
    <div className="space-y-10">
      ...
      <WebPageSchema name="Privacy Policy" description="Read the Varyense Privacy Policy: what we collect on this website, how we use it, and the choices available to you." path="/privacy-policy" />
